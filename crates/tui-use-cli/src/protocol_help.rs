...
//!
//! Generates structured documentation of the tui-use protocol,
...
fn generate_commands() -> BTreeMap<String, CommandHelp> {
        ...
        CommandHelp {
            description:
                "Interactive NDJSON driver for step-by-step TUI control. Best for LLM agents."
                    .to_string(),
            usage: "tui-use driver --stdio --json -- <command> [args...]".to_string(),
    ...
    commands.insert(
        ...
        CommandHelp {
            ...
            usage: "tui-use exec --json [--policy <path>] -- <command> [args...]".to_string(),
            required_flags: None,
    ...
    commands.insert(
        ...
        CommandHelp {
            ...
            usage: "tui-use run --json --scenario <path>".to_string(),
            required_flags: None,
            output: "Single RunResult JSON object".to_string(),
        },
    );
    ...
    commands.insert(
        ...
        CommandHelp {
            ...
            usage: "tui-use replay --artifacts <dir> [--normalize <filter>...]".to_string(),
            required_flags: None,
...
fn generate_examples() -> BTreeMap<String, Example> {
    ...
    examples.insert(
        ...
        Example {
            ...
            command: "tui-use driver --stdio --json -- /bin/cat".to_string(),
    ...
    examples.insert(
        ...
        Example {
            ...
            command: "tui-use driver --stdio --json -- /bin/bash".to_string(),
            input: Some(serde_json::json!({
                "protocol_version": 1,
                "action": {
                    "type": "key",
    ...
    examples.insert(
        ...
        Example {
            ...
            command: "tui-use exec --json -- /bin/echo hello".to_string(),
            input: None,
...
fn generate_quickstart() -> Quickstart {
    Quickstart {
        ...
        steps: vec![
            ...
            "2. Start driver: tui-use driver --stdio --json -- /tmp/your-app".to_string(),
