//! Test utilities and fixtures for ptybox integration tests.
//!
//! This crate provides fluent builder APIs and helper functions to reduce
//! boilerplate when writing tests for ptybox. It includes:
//!
...
//!
//! ```ignore
//! use ptybox_fixtures::{PolicyBuilder, ScenarioBuilder, StepBuilder, temp_dir, write_scenario};
//!
